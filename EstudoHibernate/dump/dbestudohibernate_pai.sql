...
CREATE TABLE `pai` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_hte4r8nbbbih30k4yqf101juu` (`id_filho`),
  CONSTRAINT `FK_hte4r8nbbbih30k4yqf101juu` FOREIGN KEY (`id_filho`) REFERENCES `filho` (`id`)
...
INSERT INTO `pai` VALUES (1,'Nome do Pai',1),(2,'José Pereira',2);
